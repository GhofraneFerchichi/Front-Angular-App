...
export class PostService {
  ...
  private baseUrll = 'https://localhost:8181/api/posts';
  ...
  * */
  getPosts() {
    ...
    this.http.get(this.staticService.baseUrl, this.staticService.httpOptions).subscribe(
      (response: Object) => {
  ...
  getList(): Observable<any> {
    return this.http.get(`${this.baseUrll}`+'/all');
  }
  ...
  getPost(id: number) {
   return this.http.get(this.staticService.baseUrl + '/get' + id, this.staticService.httpOptions);
  }

  savePost(post: PostModel) {
   return this.http.post(this.staticService.baseUrl , post, this.staticService.httpOptions);
  }
  ...
  updatePost(post: PostModel) {
    return this.http.put<PostModel>(this.staticService.baseUrl + post.id, post, this.staticService.httpOptions);
  }
